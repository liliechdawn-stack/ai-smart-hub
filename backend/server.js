        ...
        if (existing) {
          ...
          db.run(
            ...
            function(err) {
              ...
              res.json({
                success: true,
                message: `âœ… ${platform} account updated successfully!`,
  ...
  try {
    ...
    db.run(
      ...
      (err) => {
        ...
        res.json({
          success: true,
          message: `âœ… ${account.platform} account synced successfully`,
...
app.delete("/api/automations/accounts/:id", auth, (req, res) => {
  ...
  db.run(
    ...
    function(err) {
      ...
      res.json({
        success: true,
        message: "âœ… Account disconnected successfully"
      });
    }
  );
});
...
db.serialize(() => {
  ...
  `, (err) => {
    if (!err) console.log("âœ… Governance settings table ready");
  });
  ...
  `, (err) => {
    if (!err) console.log("âœ… Alerts table ready");
  });
  ...
  `, (err) => {
    if (!err) console.log("âœ… Usage logs table ready");
  });
  ...
  `, (err) => {
    if (!err) console.log("âœ… Agent performance table ready");
  });
  ...
  `, (err) => {
    if (!err) console.log("âœ… Mobile instances table ready");
  });
  ...
  `, (err) => {
    if (!err) console.log("âœ… Proxy usage table ready");
  });
